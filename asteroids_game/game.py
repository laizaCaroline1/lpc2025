...
class Game:
    ...
    def spawn_asteroid(self, size_key: int):
        ...
        if size_key == 3: r = 30
        elif size_key == 2: r = 20
        elif size_key == 1: r = 10
        else: r = C.ASTEROID_BASE_RADIUS
    ...
    def shoot(self):
        ...
        new_bullet = Bullet(self.ship.pos, self.ship.angle, vx, vy, self.ship)
    ...
    def update(self):
        ...
        # 1. Lógica de Colisão - Asteroides vs. Balas
        ...
        # 2. Verifica e gera nova onda de asteroides se o campo estiver limpo.
        self.check_asteroid_spawn()

        # 3. Lógica de Colisão - Nave vs. Asteroides
